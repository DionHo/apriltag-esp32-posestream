 ...
 * Based on https://github.com/raspiduino/apriltag-esp32/tree/3.4.0/examples/pose_estimate, Created by gvl610
...
namespace Apriltag{
    ...
    std::vector<apriltag_callback*> subscribers;

    void add_subscriber(apriltag_callback cb){
